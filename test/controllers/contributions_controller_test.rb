...
class ContributionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create contribution' do
    assert_difference('Contribution.count') do
      post contributions_url, params: { contribution: { ContributionType: @contribution.ContributionType } }
    end
  ...
  test 'should update contribution' do
    patch contribution_url(@contribution), params: { contribution: { ContributionType: @contribution.ContributionType } }
